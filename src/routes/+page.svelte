<div class="lg:container mx-auto h-full w-full p-8">
	<form method="POST" class="flex flex-col items-center w-full justify-center">
		...
		<div class="form-control w-full max-w-xs">
			...
			<input type="email" name="email" class="input w-full max-w-xs input-bordered" />
			<label for="email" class="label">
				<span class="label-text-alt text-error" hidden>Validation Label</span>
			</label>
		</div>
		...
		<div class="form-control w-full max-w-xs">
			...
			<input type="password" name="passwordConfirm" class="input w-full max-w-xs input-bordered" />
			<label for="passwordConfirm" class="label">
				<span class="label-text-alt text-error" hidden>Validation Label</span>
			</label>
		</div>
		<div class="form-control w-full max-w-xs pb-2">
			<label class="label cursor-pointer justify-start space-x-4">
				<input type="checkbox" name="terms" class="checkbox checkbox-primary" />
